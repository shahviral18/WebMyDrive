...
| Operation | UAPI Support | Workaround |
|-----------|-------------|------------|
| Upload files | Yes (`Fileman/upload_files`) | — |
| List files | Yes (`Fileman/list_files`) | — |
| Create directory | No (UAPI) | Upload a file to the path — auto-creates dir |
| Delete files | No (UAPI) | Use cPanel File Manager or FTP |
| Rename/move | No (UAPI) | Use cPanel File Manager |
