...
const navItems = [
    ...
    { label: "Referrals", href: "/distributor/referrals", icon: Users },
    { label: "Earnings", href: "/distributor/earnings", icon: Briefcase },
                    ...
                    <div className={cn("flex items-center gap-2 text-primary font-bold min-w-0", collapsed && !mobile && "justify-center")}>
                        ...
                        {(!collapsed || mobile) && (
                            <motion.div initial={{ opacity: 0, x: -6 }} animate={{ opacity: 1, x: 0 }} className="leading-tight min-w-0">
                                ...
                                <p className="text-[10px] text-muted-foreground">Distributor Portal</p>
                            </motion.div>
                        )}
                    </div>
                    {!mobile && !collapsed && (
                    ...
                    <div className={cn(
                        ...
                        {(!collapsed || mobile) && (
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-[10px] text-muted-foreground truncate">Distributor Partner</p>
                            </div>
                        )}
                    </div>
                    {collapsed && !mobile ? (
