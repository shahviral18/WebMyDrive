...
(async () => {
    await listFiles('public_html/WebMyDrive/demo/1/Deploy_Demo_1_Final');
    await listFiles('public_html/WebMyDrive/demo/1/');
    await listFiles('public_html/WebMyDrive/demo/1/api');
})();
